...
- **Do not pick `dual-renderview-ipd-origin`.** Dual paint is HMD-gated. Window size is persistable (`--set width/height`). Prefer a non-menu, non-toast offline gap — do not invent chrome.
